    ...
    switch (culture) {
        case "ru":
            localization =
            {
                ...
                pagerrangestring: " из ",
                pagerpreviousbuttonstring: "следующая",
                pagernextbuttonstring: "предыдущая",
                pagerfirstbuttonstring: "первая",
                pagerlastbuttonstring: "последняя",
                groupsheaderstring: "Перетащите столбец и поместите его сюда, чтобы сгруппировать после этого столбца",
                ...
                filterstring: "Фильтр",
                filtershowrowstring: "Показать строки, в которых:",
                ...
                filterstringcomparisonoperators: ['пустая', 'не пустая', 'содержит', 'совпадение',
                    'не содержит', 'не содержит (соответствует регистру)', 'начинается с ', 'начинается с (соответствует регистру)',
                    'заканчивается на', 'заканчивается на (регистр совпадений)', 'равно', 'равно (совпадение)', 'равно нулю', 'не равно нулю'],
                filternumericcomparisonoperators: ['равно', 'не равно', 'меньше', 'меньше или равно', 'больше', 'больше или равно', 'равно нулю', 'не равно нулю'],
                filterdatecomparisonoperators: ['равно', 'не равно', 'меньше', 'меньше или равно', 'больше', 'больше или равно', 'равно нулю', 'не равно нулю'],
                filterbooleancomparisonoperators: ['равно', 'не равно'],
                validationstring: "Введенное значение не действительно",
