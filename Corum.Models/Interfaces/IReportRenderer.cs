...
namespace Corum.Models.Interfaces
{
    public partial interface IReportRenderer
    {
        ...
        byte[] OrderRenderReport<T>(OrderBaseViewModel OrderTypeModel, OrdersPassTransportViewModel extOrderTypeModel, string AcceptDate, OrderClientsViewModel orderClientInfo, RestParamsInfo Params, string AdressFrom, string AdressTo, string ContractName, OrdersTruckTransportViewModel extOrderTypeModel2, int OrderType, List<OrderUsedCarViewModel> carList, ViewModels.Tender.DataToAndFromContragent data);
        ...
        byte[] OrderRenderReport<T>(OrderBaseViewModel OrderTypeModel, OrdersPassTransportViewModel extOrderTypeModel, string AcceptDate, OrderClientsViewModel orderClientInfo, RestParamsInfo Params, string AdressFrom, string AdressTo, string ContractName, OrdersTruckTransportViewModel extOrderTypeModel2, int OrderType, List<OrderUsedCarViewModel> carList, List<ViewModels.Tender.DataToAndFromContragent> data);
    }
}