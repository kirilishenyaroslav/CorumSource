...
// Type: GridMvc.Columns.IGridColumn`1
...
{
  public interface IGridColumn<T> : IGridColumn, ISortableColumn, IFilterableColumn, IColumn<T>, ISortableColumn<T>, IColumn, IFilterableColumn<T>
  {
  }
}
